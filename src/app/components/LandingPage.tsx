    ...
    <div className="flex flex-col min-h-screen bg-white">
      <header className="px-6 lg:px-10 h-20 flex items-center border-b sticky top-0 bg-white/95 backdrop-blur-sm z-50 shadow-sm">
        ...
        <nav className="ml-auto flex gap-8">
          <Link
            href="/map"
            className="text-sm font-bold text-white bg-red-600 hover:bg-red-700 px-4 py-2 rounded-full transition-colors"
          >
            View Map
          </Link>
        </nav>
              ...
              <div className="space-y-10 text-center lg:text-left">
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-gray-700 max-w-2xl mx-auto lg:mx-0 drop-shadow-sm">
                    Empowering California GovOps agencies with real-time fire
                    hazard safety data for the UC Davis community.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
                  ...
                  <Link href="#data">
                    <Button
                      variant="outline"
                      className="px-10 py-7 text-xl font-semibold border-red-200 text-red-700 hover:bg-red-50 rounded-xl transition-all duration-300 hover:scale-105"
                    >
                      Learn More
                    </Button>
                  </Link>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center space-y-8 mb-16">
              ...
              <p className="text-xl text-gray-600">
                FireZero combines two powerful datasets to provide comprehensive
              ...
              {[
                {
                  title: "CEED",
                  description:
                    "The UC Davis Campus Energy and Environmental Data (CEED) provides detailed utility usage information (energy, water, gas, etc.) for various UC Davis facilities.",
                ...
                },
                {
                  ...
                  description:
                    "The Clery building-level fire safety reports provide specific information about fire safety measures in campus buildings, including fire alarms, drills, and sprinkler systems.",
                ...
                <div
                  key={index}
                  className="flex flex-col p-10 bg-white rounded-2xl shadow-xl text-left space-y-6 transition-all duration-300 hover:shadow-2xl group border border-gray-100"
                >
                  <div className="flex items-center space-x-4">
                    <div
                      className={`p-3 rounded-xl ${item.color} text-white group-hover:scale-110 transition-transform duration-300`}
                    >
